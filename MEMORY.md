...
- `reference/` — detailed derivations by topic (11 files)
- `calculations/` — code organized by topic (core/, coupling/, masses/, bonding/, atomic/, simulations/, vacuum_polarization/, cosmology/)
- `calculations/core/gwt_lagrangian.py` — code implementation (must match reference doc)
...
- `notes/` — active notes (TODO-zero-crossing.md) + archive of old EWT-era files
- `calculations/archive/` — old exploration scripts preserved for reference
...
- **Source of truth hierarchy**: `gwt_complete_reference.md` + `reference/` → `calculations/core/gwt_lagrangian.py` → website
...
- Key files: `calculations/archive/bond_v8_rederived.py`, `calculations/bonding/bare_hessian_multimode.py`
...
2. **Lattice DFT** — radial Kohn-Sham with Oh exchange functional
   ...
   - Key file: `calculations/archive/gwt_lattice_dft.py`
...
Key files:
- `calculations/archive/toroidal_mode_decomposition.py` — main 3D GPU simulation
- `calculations/archive/toroidal_deep_analysis.py` — fine R scan, decay rates, radial profiles
- `calculations/archive/toroidal_breather_modes.py` — 8-mode mapping, Oh decomposition
- `calculations/archive/breather_mode_shift.py` — 1D self-consistent mode correction
...
Key files:
- `calculations/archive/multimode_interaction.py` — 7-mode coupling, additivity test
- `calculations/archive/mode_coupling_matrix.py` — overlap matrix, well-filling vector
- `calculations/archive/mode_balance_model.py` — 1-parameter constrained model (partial success)
...
- `calculations/archive/bond_angular_analysis.py` — fine angular scan, σ/π/δ classification, ratios
...
Key file: `calculations/archive/bond_v8_rederived.py`
...
Key file: `calculations/bonding/bare_hessian_multimode.py`
...
are documented in `gwt_complete_reference.md` and `reference/`. Do not duplicate here.
