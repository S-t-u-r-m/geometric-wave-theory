...
- `calculations/` — code implementation (gwt_lagrangian.py, pmns_formula.py, ckm_formula.py, etc.)
...
- **Source of truth**: `math/gwt_complete_reference.md` is the authoritative reference. `calculations/gwt_lagrangian.py` is the code implementation and must match it.
...
## GWT Lagrangian Code Implementation — COMPLETE (March 5 2026)
File: calculations/gwt_lagrangian.py — code implementation (must match math/gwt_complete_reference.md)
