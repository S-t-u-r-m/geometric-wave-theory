...
### [14. Optics](reference/optics.md)
Refraction from impedance mismatch (kinks change local spring properties). Snell's law from wave equation boundary conditions. Dispersion from resonant coupling to harmonic modes. Polarization = T1u vector direction. Reflection, diffraction, birefringence, photoelectric effect, Cherenkov radiation. All from waves on springs with varying stiffness.

### [15. Toroidal Breather Physics](reference/toroidal_physics.md)
...
### [16. Cosmological Parameters](reference/cosmology.md)
...
### [18. Radioactive Decay](reference/radioactive_decay.md)
Alpha decay (kink cluster tunneling), beta decay (torus mode conversion via SU(2)), gamma decay (harmonic relaxation), fission (topology splitting), fusion (topology merging). All from the cosine potential barrier. Geiger-Nuttall law from WKB. Sargent's rule E^5 = (2d-1)-body phase space. Iron peak at A ~ 56 from d=3 geometry.

### [19. Nuclear Physics, Mesons & Electromagnetic Moments](reference/nuclear.md)
...
### [20. Lattice Corrections, Symmetry & N-Body Oh Framework](reference/lattice_and_symmetry.md)
